          ...
          <div className="mx-auto max-w-7xl grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div>
              ...
              <h1 className="max-w-xl text-4xl font-black leading-tight text-white sm:text-5xl tracking-tighter">
                I'm <span className="text-blue-500">Len</span>, a Traditional
                Artist.
              </h1>
              <p className="mt-6 max-w-lg text-sm leading-8 text-slate-400 sm:text-base">
                ...
                <br />
                <br />
                Currently, I'm focusing on my studies rather than creating arts,
                but I will soon expand my portfolio with more detailed pencil
                renderings and other portraits. Hoping to create arts in
                differents styles but same material usage.
              </p>
              <div className="mt-8 flex gap-4">
                <Button to="/" variant="primary">
                  Back Home
                </Button>
                <Button to="/OtherWorks">View Gallery</Button>
              </div>
            </div>
          </div>
        </section>
