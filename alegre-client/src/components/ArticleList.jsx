    ...
    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {articles.map((article, index) => {
        ...
        return (
          ...
          >
            <div className="overflow-hidden rounded-2xl bg-black/40 aspect-video flex items-center justify-center">
              {imageSrc ? (
                <img
                  src={imageSrc}
                  alt={article.title}
                ...
                <div className="flex h-full w-full items-center justify-center bg-black/20 text-slate-400">
                  No image
                </div>
              )}
            </div>
